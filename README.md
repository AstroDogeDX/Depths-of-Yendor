...
Some themes add features to their rooms, like the Sewers' water channels and the Catacombs' spike pits (see *The dungeon*).
...
src/
  ...
  dungeon/props.js     loads Blockbench furniture on demand and places it: meshes, obstacles, item slots, candles
  dungeon/decor.js     decorations by theme style, set about the rooms clear of doorways
  dungeon/channels.js  trenches across rooms, crossed by bridges: the Sewers' water channels and the Catacombs' spike pits

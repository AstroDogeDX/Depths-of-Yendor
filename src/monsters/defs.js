...
export const MONSTERS = {
  ...
  skeleton: {
    ...
    xp: 6, depth: [4, 9], freq: 8, dodge: 0.05, def: 2, sleepChance: 0.7,
  },
  orc: {
    name: 'orc', hp: 28, dmg: [4, 11], speed: 2.8, radius: 0.42, reach: 1.8, windup: 0.6, cooldown: 1.2,
    xp: 9, depth: [5, 10], freq: 8, dodge: 0.05, def: 2, sleepChance: 0.5,
  },
  wraith: {
    name: 'wraith', hp: 22, dmg: [4, 9], speed: 3.2, radius: 0.35, reach: 1.6, windup: 0.5, cooldown: 1.1,
    xp: 11, depth: [6, 10], freq: 5, dodge: 0.25, def: 0, sleepChance: 0.2, flying: 0.4,
  ...
  imp: {
    ...
    xp: 10, depth: [7, 10], freq: 5, dodge: 0.2, def: 1, sleepChance: 0.3, fireImmune: true,
  ...
  troll: {
    ...
    xp: 16, depth: [7, 10], freq: 5, dodge: 0, def: 3, sleepChance: 0.6, regen: 1.2,
  },
  golem: {
    name: 'stone golem', hp: 75, dmg: [9, 20], speed: 1.7, radius: 0.55, reach: 2.1, windup: 0.9, cooldown: 1.6,
    xp: 22, depth: [8, 10], freq: 3, dodge: 0, def: 6, sleepChance: 0.8,
  },
  warden: {
